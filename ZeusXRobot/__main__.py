...
STICKERS = (
      ...
      "CAACAgUAAxkBAAIYBmHb2jX7PEfNRbW_6_GRKMSJvU36AALOAwACq2fhVt8MiYBinMXnIwQ", #2
)
...
If you want to report bugs or have any questions on how to use me then feel free to reach out: @SizukiXSupport.
All commands can be used with the following: *(/),(!),(?),(.),(~)*[!](https://telegra.ph/file/fc8e9cca3f4e1cefb2e1d.jpg)
...
HELP_IMG= "https://telegra.ph/file/7d8b56b5e0f333b1e39fb.jpg"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  ...
                  [
                    InlineKeyboardButton(text="📢 Updates", url="t.me/SizukiXupdate"),
                 ],
                 [
                    InlineKeyboardButton(text="⬅ Back", callback_data="zeus_back"),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}","*Sizuki Is Ready ⚡*", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
